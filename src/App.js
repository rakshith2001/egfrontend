...
function App() {
  ...
  async function convertCode() {
    try {
      ...
      let req = await fetch(`http://localhost:4500/api/convert`, {
        method: "POST",
        headers: {
  ...
  async function debugCode() {
    ...
    try {
      let req = await fetch(`http://localhost:4500/api/debug`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  async function checkCodeQuality() {
    ...
    try {
      ...
      let req = await fetch(`http://localhost:4500/api/qualityCheck`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  async function executeCode() {
    try {
      ...
      let req = await fetch(`http://localhost:4500/api/execute`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
